...
GIF가 “한 번의 run에서 무슨 일이 일어났는가?”를 보여준다면, gallery는 “seed만 바꿨을 때 얼마나 흔들리는가?”를 보여줍니다. 생성되는 Markdown report는 이제 best/worst seed의 storyboard와 metrics를 본문에 바로 넣어줘서 첫 확인 때 클릭을 덜 하게 해줍니다. 예시는 [docs/media/make_moons_seed_report.md](./docs/media/make_moons_seed_report.md)에서 볼 수 있습니다.
